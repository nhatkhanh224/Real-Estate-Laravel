        ...
        <div class="row">
            <div class="col-lg-7 col-md-12 cp-2">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                        <div class="overview overview-box">
                            <img src="https://kenhhomestay.com/wp-content/uploads/2019/03/Dia-diem-du-lich-Binh-Duong-1.jpg" alt="popular-places">
                            <div class="mask">
                                <div class="info">
                                    <div class="ds">
                                        <h2>Bình Dương</h2>
                    ...
                    <div class="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                        <div class="overview overview-box">
                            <img src="https://hanoimoi.com.vn/Uploads/images/tuandiep/2020/08/20/ho-hoan-kiem.jpg" alt="popular-places">
                            <div class="mask">
                                <div class="info">
                                    <div class="ds">
                                        <h2>Hà Nội</h2>
            ...
            <div class="col-lg-5 col-md-12 col-pad cp-3 wow fadeInRight delay-04s">
                <div class="overview aa overview-box">
                    <img src="https://mekonglogistics.vn/wp-content/uploads/2021/03/du-lich-da-nang.jpg" alt="popular-places" class="big-img">
                    <div class="mask">
                        <div class="info-2">
                            <div class="ds">
                                <h2>Đà Nẵng</h2>
